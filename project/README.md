...
A tongue-in-cheek Python script that turns any boring text file into proper movie-style hacking.
...
Double-click `hollywoodhacker.py` in File Explorer

OR open terminal/PowerShell in the project folder and run:
```bash
...
### With your own file
```bash
python hollywoodhacker.py yourfile.txt
```

### If `python` doesn't work, try:
```bash
py hollywoodhacker.py
```
or
```bash
python3 hollywoodhacker.py